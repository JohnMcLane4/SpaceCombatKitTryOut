...
namespace VSX.UniversalVehicleCombat
{
    public class SpaceshipAttackBehaviour : AISpaceshipBehaviour
    {
        ...
        public override bool BehaviourUpdate()
        {
            ...
            Vector3 targetPos = weapons.TargetLeaders.Count > 0 ? weapons.TargetLeaders[0].LeadTargetPosition : 
                                                                    weapons.WeaponsTargetSelector.SelectedTarget.transform.position;
